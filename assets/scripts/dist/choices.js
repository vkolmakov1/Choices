	  ...
	  _createClass(Choices, [{
	    ...
	    value: function setChoices(choices, value, label) {
	      ...
	      if (choices && choices.length) {
	        ...
	        var groups = choices.filter(function (result) {
	          return result.choices;
	        });
	        var individualChoices = choices.filter(function (result) {
	          return !result.choices;
	        });

	        groups.forEach(function (group) {
	          return _this12._addGroup(group, group.id || null, group.value, group.label);
	        });
	    ...
	    key: '_addMultipleIndividualChoices',
	    value: function _addMultipleIndividualChoices(choices) {
	      var _this13 = this;

	      var existingChoices = this.store.getChoices();
	      var firstChoiceId = existingChoices ? existingChoices.length + 1 : 1;

	      var getChoiceElementId = function getChoiceElementId(choiceIndex) {
	        return _this13.baseId + '-' + _this13.idNames.itemChoice + '-' + choiceIndex;
	      };
	      var createAddChoiceAction = function createAddChoiceAction(choice, idx) {
	        return (0, _index3.addChoice)(choice.value, choice.label || choice.value, firstChoiceId + idx, choice.groupId || -1, choice.isDisabled, getChoiceElementId(firstChoiceId + idx), choice.customProperties, choice.placeholder || false, choice.keyCode || false);
	      };

	      var addSelectedChoiceAsItem = function addSelectedChoiceAsItem(choice, idx) {
	        return _this13._addItem(choice.value, choice.label || choice.value, getChoiceElementId(firstChoiceId + idx), undefined, choice.customProperties, choice.placeholder, choice.keyCode);
	      };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxBatch = __webpack_require__(26);
	...
	var Store = function () {
	  function Store() {
	    ...
	    this.store = (0, _redux.createStore)(_index2.default, _reduxBatch.reduxBatch, window.devToolsExtension ? window.devToolsExtension() : undefined);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxBatch = __webpack_require__(28);
...
/***/ (function(module, exports) {
	...
	function reduxBatch(next) {
	    ...
	    var nextListeners = [];
	    var currentListeners = currentListeners;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _choices = __webpack_require__(32);
